...
import eam.edu.co.ParcheVacaciones.Excepciones.AlmacenException;
import eam.edu.co.ParcheVacaciones.Excepciones.FileNotFoundException;
...
@Service
public class AlmacenImplementation implements AlmacenService{
